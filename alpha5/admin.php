...
<html>
	...
	<div class="container">
		...
		<div id="Admin_Section"  class="Admin_Section"><center>
	<b>Hello <?php echo htmlentities($_SESSION['user']['username'], ENT_QUOTES, 'UTF-8'); ?>!</b><br /><hr style="width: 50%"/>
	<div class="Admin_PHP_Admin_Section">
<a href="post.php">Make a post</a><br />
<a href="edit-account.php">Edit Account</a><br />
<a href="index.php">Full View Site</a><br />
<a href="release_log.php">Release Log</a><br />
<a href="to-do-list.php">Next in Development</a><br />
