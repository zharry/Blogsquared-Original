...
<html>
	...
	<script src="includes/showhide.js" type="text/javascript"></script>
    	<script src="includes/addwords.js" type="text/javascript"></script>
        <script src="includes/changetext.js" type="text/javascript"></script>
        <script src="includes/handeler.js" type="text/javascript"></script>
...
<form action="post.php" method="post">
    ...
    <br /><br />
    Post: &nbsp
    <a id="change_bold"><input type="button" value="<b>" onclick="func1()" /></a><a id="change_italics"><input type="button" value="<i>" onclick="func3()" /></a><a id="change_underline"><input type="button" value="<u>" onclick="func5()" /></a><br />
    <textarea rows="10" cols="35" name="post" id="textBox"></textarea>
    <br /><br />
