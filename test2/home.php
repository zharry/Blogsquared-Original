...
<div style="float:left; width: 60%;">
	...
	<input name="submit" type="submit" value="Submit">
        <br/><br/><small><a href="http://www.myrandomblog.tk/test2/clear.php">Clear Log</a></small>
</div>
<div style="float:left; width: 40%;">
</div>
<iframe src="http://www.myrandomblog.tk/test2/Output.php" width=100% height=1000 scrolling=yes frameborder=1></iframe>
	</body>
	</html>